...
var require_pem_jwk = __commonJS({
  "../node_modules/pem-jwk/index.js"(exports, module) {
    ...
    function hex2b64url(str) {
      return urlize(Buffer3.from(str, "hex").toString("base64"));
    }
    ...
    function pem2jwk(pem, extras) {
      ...
      return decoder(Buffer3.from(text.replace(/[^\w\d\+\/=]+/g, ""), "base64"), extras);
    }
    ...
    function base64url2bn(str) {
      return new asn.bignum(Buffer3.from(str, "base64"));
    }
